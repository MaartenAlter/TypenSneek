        ...
        <div class='row'>
            <div class='col-sm'>
                <div class='col-sm rounded p-3 ' style='margin-top:101px; background: #ffffe6; max-width: 1100px'>
                    <h4 class='mx-auto'>Hoi, <?php echo $_SESSION['username'];?></h4>
                    <hr>
                    <p>
                        Leuk dat je er bent! De typcursus staat voor je klaar. Om te beginnen klik de knop hieronder. En
                        voor vragen kun je altijd de online coach gebruiken.
                    </p>
                    <br>

                    <button type='button' class='btn btn-outline-primary'
                        onclick="window.location.href='lessen.php';">Cursus</button>
            ...
            <div class='col-sm'>
                <div class='col-sm'>
                    <div class='col-sm rounded p-3 ' style='margin-top:101px; background: #F5E6CC; max-width: 1100px'>
                        ...
                        <hr>
                        <p>
                            Als je vragen of een opmerking hebt, kun je die stellen via de HulpCoach. klik op de knop
                            hier onder!<br><br>
                        </p>
                        <br>
                        <?php
            if ($_SESSION["usertype"] == "admin") {
                echo "<button type='button' class='btn-outline-danger btn border-2'>
                    <a class='nav-link' style='color: black' onclick=\"window.location.href='coachchat.php';\">Beheer</a>
                </button>";
            }else{
                echo "<button type='button' class='btn btn-outline-primary' onclick=\"window.location.href='chat.php';\">Hulpcoach</button>";
            }
            ?>
...
?>
            ...
            <div class='container'>
                <div class='row'>
                    <div class='col-sm'>
                        <div class='col-sm rounded p-3 '
                            style='margin-top:50px; background: #F5E6CC; max-width: 1100px'>
                            ...
                            <?php
                                echo "<button type='button' class='btn-outline-danger btn border-2'>
                                        <a class='nav-link' style='color: black' onclick=\"window.location.href='adminpage.php';\">Beheer</a>
                                    </button>";    
                    ...
                    <div class='col-sm'>
                        <div class='col-sm'>
                            <div class='col-sm rounded p-3 '
                                ...
                                <br>
                                <button type='button' class='btn-outline-danger btn border-2'>
                                    <a class='nav-link' style='color: black' href='CMS/read.php'>CMS</a>
                                </button>
