    ...
    <div class='col-sm'>
          <div class='col-sm'>
           ...
           <h4 class='mx-auto'>Vragen?</h4>
            ...
            <br>
            <button type='button' class='btn btn-outline-primary'><a href='#'>Hulp Coach</a></button>
    ...
    <div class="row">
        <div class="col-sm rounded mr-5 p-3" style="background: #fca62a; color: black; font-size: larger; " >
          ...
          <hr>
            ...
            <br>
            <div class="col-sm" >
                <button type="button" formaction="Contact.php" class="btn btn-lg rounded-pill " style="color: black; background-color: #23a5ed;"><a style="color: white" href="Contact.php">Neem contact op!</a></button>
                <button type="button" formaction="Contact.php"  class="btn btn-lg rounded-pill" style="color: black; background-color: #23a5ed;"><a style="color: white" href="proefles.php">Doe een proefles</a></button>
            </div>
        </div>';
        ...
        <div class="container" style="color: black;">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <h3 style="text-decoration: none; color: #23a5ed; font-weight: bold;">Menu</h3>
                    <hr>

                    <ul class="column list-unstyled">
                        <li><a href="aanmelden.php" style=" color: white; font-weight: bold;"><i class="fa fa-angle-double-right" ></i>Aanmelden</a></li>
                        <li><a href="Blindtypen.php" style=" color: white; font-weight: bold;"><i class="fa fa-angle-double-right"></i>Blindtypen</a></li>
                        <li><a href="Dyslexie.php" style=" color: white; font-weight: bold;"><i class="fa fa-angle-double-right"></i>Dyslexie</a></li>

                    </ul>
                </div>

                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <h3 style="color: #23a5ed; font-weight: bold;">Menu</h3>
                    <hr>
                    <ul class="column list-unstyled">

                        <ul class="column list-unstyled" >
                            <li><a href="Ervaringen.php" style="  color: white; font-weight: bold;"><i class="fa fa-angle-double-right"></i>Ervaringen</a></li>
                            <li><a href="lessen.php" style="  color: white; font-weight: bold;"><i class="fa fa-angle-double-right"></i>De cursus</a></li>
                            <li><a href="Contact.php" style="  color: white; font-weight: bold;"><i class="fa fa-angle-double-right"></i>Contact</a></li>
                        </ul>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center">
                    <h3 style=" color: #23a5ed; font-weight: bold;">Contact</h3>
                    <hr>
                    <ul class="column list-unstyled">
                        <li style=" color: white; font-weight: bold;">Pinksterbloem 26</li>
                        <li style=" color: white; font-weight: bold;">8607 DV SNEEK</li>
                        <li style=" color: white; font-weight: bold;">0515 - 419424</li>
                    </ul>
                </div>
            </div>
        </div>
