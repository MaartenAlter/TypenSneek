...
<p hidden id="course">a a a a a aa aa aa aa aa aaa aaa aaa aaa aaa a aa aaa a aa aaa
a a a aa aa aa aaa aaa aaa aa aa aa a a a aa aaa a aa a aaa aa
a aa aaa aa a a a aa aa aaa aaa aaa aa aa aaa aaa aa aa a a aa
</p>

<p hidden id="lesson">1</p>
<p hidden id="exercise">10</p>
<body>
<form action="" method="post" id="scoreForm" >
  <div class="container">
    <div class="heading">TypenSneek - Les 1 Oefening 10</div>
    <div class="header">
      <div class="wpm">
  ...
  <h1>Aanwijzingen</h1>
  <p>De derde letter van deze les is de a. Deze doe je met je linker pink.
